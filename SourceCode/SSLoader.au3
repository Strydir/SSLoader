...
Global $Checkbox_Add_break, $Combo_Add_break, $Combo_SteamLibrary, $GamePath, $IconPath, $WebURL
Global $Array_tools_vrmanifest_File, $Array_tools_vrmanifest_File, $Line_NR_binary_path_windows
Global $WMR_Keyname, $hImage, $hGraphic, $Xplaque, $Yplaque, $Zplaque
...
;	GUICtrlSetFont(-1, 26, 600, 7, "arial")
	...
	Global $Create_Plaques = GUICtrlCreateButton("Create Plaques", 600, 54, 100, 24)
;	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
;	GUICtrlSetColor(-1, $COLOR_RED)
	GuiCtrlSetTip(-1, "Click to make your selected games into GamePlaques")
...
;	GUICtrlSetOnEvent($Button_WindowsMR, "_WMR_Reg_Op")
	GUICtrlSetOnEvent($Create_Plaques, "_Write_2_Room")
...
;_GUICtrlListView_SetBkColor(-1, 0xADFF2F)
	...
	; Add columns
;	_GUICtrlListView_AddColumn($listview, "NR", 85)  ; un remmed
...
;_GUICtrlListView_AddItem($listview_Temp, $ListView_RowNR, $Application_NR, 0)
...
Func _Write_2_Room()
;	_GUICtrlStatusBar_SetText($Statusbar, "Creating Game Plaques...")
$Xplaque = -1.18
$Yplaque = 1
$Zplaque = -1
...
;$ApplicationList_TEMP = $ApplicationList_Folder & "ApplicationList_SteamLibrary_1.ini"
	...
	If $TEMP_NR_selected = "true" Then
		...
		_GUICtrlListView_SetItemChecked($listview_Temp, -1, False)
		GUICtrlSetData($Display_Progressbar, 100)
;		_GUICtrlStatusBar_SetText($Statusbar, "Game Plaques created." & @TAB & @TAB & "'Version " & $Version & "'")
...
Func _Write_Cut_2_Room()
	Local $lineCount = _FileCountLines($Room) - 2
	_FileWriteToLine($Room, $lineCount - 1, "  },", True)
	_FileWriteToLine($Room, $lineCount, ' "SteamShortcut_' & $AppId & '_000e59b7e041e22c": {' & @CRLF & _
					'	"AppId": ' & $AppId & ',' & @CRLF & _
					'	"Children": {' & @CRLF & _
