...
;MsgBox(1, "PlaceHolder", "not")
	...
	Global $Button_Start_SteamVR = GUICtrlCreateButton("Start SteamVR", 405, $DesktopHeight - 82, 145, 29)
	...
	Global $Button_Create_GamePage1 = GUICtrlCreateButton("Create Game Page", 205, $DesktopHeight - 87, 166, 35, $BS_BITMAP)
