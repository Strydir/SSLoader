...
#AutoIt3Wrapper_Icon=C:\Users\Phantom\OneDrive\Documents\ObjectDock Library\Icons\SSLoader.ico
#AutoIt3Wrapper_Outfile=SSLoader.exe
#AutoIt3Wrapper_Outfile_x64=SSLoader64.exe
...
Global $listview, $listview_2, $listview_3, $listview_4, $listview_5, $listview_6, $CheckBox_Restart, $Icon_Preview, $ApplicationList_TEMP, $AppList, $Status_Combo_Add_to_Custom
...
Global $contextmenu, $RM_ItemList, $RM_Item0, $RM_Item1, $RM_Item2, $RM_Item3, $RM_Item3a, $RM_Item4, $RM_Item5, $RM_Item6, $RM_Item7,$RM_Item8,$RM_Item9, $RM_Item10, $RM_Item11, $RM_Item12, $RM_Item13, $Launch_String
Global $RM_Item14, $RM_Item15, $RM_Item16, $RM_Item17, $RM_Item18, $RM_Item19, $Checkbox_Add_break, $Combo_Add_break, $Combo_SteamLibrary, $GamePath, $IconPath, $WebURL, $Sep_AppID_Num
Global $Array_tools_vrmanifest_File, $Array_tools_vrmanifest_File, $Line_NR_binary_path_windows, $Custom_Tab_Label1, $Custom_Tab_Label2, $Custom_Tab_Label3, $Custom_Tab_Label4, $Exit_Label
Global $WMR_Keyname, $hImage, $hGraphic, $Xplaque, $Yplaque, $Zplaque, $XarcA, $YarcA, $ZarcA, $Xeagle1, $Yeagle1, $Zeagle1, $EagleSize, $Xmonitor1, $Ymonitor1, $Zmonitor1
Global $aReturn, $aReturn_Temp, $aReturn_List, $aReturn_List2, $aReturn_List3, $aReturn_List4, $aReturn_List5, $aReturn_List6, $aReturn_List7, $aReturn_List8, $aReturn_List9
Global $OPForm1, $OPRadio1, $OPRadio2, $OPRadio3, $OPRadio4, $OPRadio5, $OPRadio6, $OPRadio7, $OPRadio8, $OPRadio9, $Object_Type, $ObjectPath, $Cabinet
...
Global $Sep_Name, $Install_Drive, $search_LocalFolder, $fileCK1, $aAppId, $aName, $aFileType, $aInstallDrive, $aSoD, $aIconPath, $aLineString, $aGamePath, $aWebURL
...
Global $iniTemp = $ApplicationList_Folder & "iniTemp.ini"
...
Global $Room = @MyDocumentsDir & "\my games\VR Toolbox\save\SessionRoom.json"
Global $Object_Room = @MyDocumentsDir & "\my games\VR Toolbox\save\Objects.room"
...
Global $startpagesize = 73
Global $startpagesize = 90
Global $tempcount = 0
Global $temptest = 20
...
If @OSArch = "x64" Then
	...
	Global $VRTbx_DIR = RegRead('HKLM64\Software\Microsoft\Windows\CurrentVersion\Uninstall\Steam App 488040', "InstallLocation")
	Global $VRTbx_File_LnCnt = _FileCountLines($VRTbx_DIR & "\utils\StartPage.html")
;	MsgBox(0, "", "vrtbx dir: " & $VRTbx_DIR)
;	MsgBox(0, "", "startpage line count: " & $VRTbx_File_LnCnt)
Else
	...
	Global $VRTbx_DIR = RegRead('HKLM\Software\Microsoft\Windows\CurrentVersion\Uninstall\Steam App 488040', "InstallLocation")
	Global $VRTbx_File_LnCnt = _FileCountLines($VRTbx_DIR & "\utils\StartPage.html")
EndIf
...
;	_Loading_GUI()
SplashImageOn("Loading...", $gfx& "Splash.jpg", 229, 215)
...
Global $Label_EditMode = GUICtrlCreateLabel(">Edit Mode<", 260, 18, 140, 32)
	GUICtrlSetFont(-1, 16, 400, 7, "Comic Sans MS")
	GUICtrlSetColor(-1, $COLOR_RED)
	GUICtrlSetState($Label_EditMode, $GUI_HIDE)

Global $Button_CancelEdit = GUICtrlCreateButton("-Cancel-", 280, 1, 80, 20)
	GUICtrlSetFont(-1, 9, 400, 7, "Comic Sans MS")
	GUICtrlSetState($Button_CancelEdit, $GUI_HIDE)

Global $Group_Sort = GUICtrlCreateGroup("Sort by: ", 3, 48, 236, 40, $BS_CENTER)
;	GUICtrlSetFont(-1, 6, 400, 7, "Comic Sans MS")
	Global $Button_SortAppId = GUICtrlCreateButton("AppId", 8, 65, 70, 20)
;	_GUICtrlButton_SetImage($Button_Open_Page, $gfx & "OpenPage.bmp")
	...
	Global $Button_SortName = GUICtrlCreateButton("Name", 86, 65, 70, 20)
	GuiCtrlSetTip(-1, "Sort List by Name: Toggles Up or Down" & @CRLF & _
					'Note that all Separators will be moved to the top/bottom of the page')
	Global $Button_Drive = GUICtrlCreateButton("Drive", 164, 65, 70, 20)
	GuiCtrlSetTip(-1, "Sort List by Install Drive: Toggles Up or Down" & @CRLF & _
					'Note that all Separators will be moved to the top/bottom of the page')

	Global $Group_Save = GUICtrlCreateGroup("Drag n Drop", 256, 48, 135, 32, $BS_CENTER)
	Global $Button_Edit = GUICtrlCreateButton("Edit", 265, 65, 55, 22)
	GuiCtrlSetTip(-1, "Click to enable Drag n Drop editing." & @CRLF & _
						"Click 'Save' to save your edits." & @CRLF & _
					'Note: If your icons are missing, then you are in edit mode' & @CRLF & _
					"-don't forget to save your changes!")
	Global $Button_Save = GUICtrlCreateButton("Save", 330, 65, 55, 22)
	GuiCtrlSetTip(-1, "To save your Drag n Drop edits, click 'Save'" & @CRLF & _
					'Note: If your icons are missing, then you are in edit mode' & @CRLF & _
					"-don't forget to save your changes!")

	Global $SteamHome_Label = GUICtrlCreateLabel("SteamVR Home", 382, 0, 240, 41)
	...
	Global $Display_WinHome = GUICtrlCreateButton($WinName, 404, 46, 188, 38, $SS_CENTER)
	GUICtrlSetFont(-1, 17, 400, 0, "Comic Sans MS")
	GUICtrlSetBkColor(-1, $Set_HomeColor)
	GuiCtrlSetTip(-1, "-Click to change-")

	Global $Create_Plaques = GUICtrlCreateButton("Create Objects", 606, 54, 75, 34, $BS_MULTILINE)
;	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
;	GUICtrlSetColor(-1, $COLOR_RED)
	GuiCtrlSetTip(-1, "Click to make your selected games into Object Shortcuts" & @CRLF & _
						'Access these shortcuts by loading the Room named "Objects"' )

	Global $ClearRoom = GUICtrlCreateButton("Clear" & @CRLF & "Room", 692, 54, 70, 34, $BS_MULTILINE)
;	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
;	GUICtrlSetColor(-1, $COLOR_RED)
	GuiCtrlSetTip(-1, 'Clear the "Objects" Room of all Object Shortcuts')
...
#ce
	...
	If $WinName = "VR Toolbox" Then
		...
		GUICtrlSetState($ClearRoom, $GUI_SHOW)
		GUICtrlSetState($Create_Plaques, $GUI_SHOW)
	Else
		GUICtrlSetState($Button_Start_Page, $GUI_HIDE)
		GUICtrlSetState($Button_Master_Page, $GUI_SHOW)
		GUICtrlSetState($ClearRoom, $GUI_HIDE)
		GUICtrlSetState($Create_Plaques, $GUI_HIDE)
	EndIf
...
;	GUICtrlSetOnEvent($TVCuts_Page, "_TV_Cuts")
	...
	GUICtrlSetOnEvent($Button_Edit, "_Edit_List")
	GUICtrlSetOnEvent($Button_Save, "_DragDrop_Save")
	GUICtrlSetOnEvent($Button_CancelEdit, "_Cancel_Edit")
	GUICtrlSetOnEvent($Create_Plaques, "_Object_Picker")
...
;	GUICtrlSetOnEvent($Button_Start_VRToolbox, "_Button_Start_VRToolbox")
	...
	GUICtrlSetOnEvent($RM_Item8, "_RM_Menu_Item_8") ; up
	GUICtrlSetOnEvent($RM_Item9, "_RM_Menu_Item_9") ; down

	GUICtrlSetOnEvent($RM_Item12, "_Edit_List")
	GUICtrlSetOnEvent($RM_Item13, "_DragDrop_Save")
	GUICtrlSetOnEvent($RM_Item14, "_Cancel_Edit")
	GUICtrlSetOnEvent($RM_Item17, "_RM_Menu_Item_17")  ; AddSeparator
	GUICtrlSetOnEvent($RM_Item19, "_RM_Menu_Item_19")  ; Delete
...
;        ConsoleWrite("Test = " & $test & $test1 & @CRLF)
;		$test1 = $test1 + 1
;	EndIf
WEnd
#endregion
...
Func _Find_Game()
		...
		Local $TempAppID = _GUICtrlListView_GetItemText($listview_Temp, $ListView_Selected_Row_Index, 1)
		Local $TempName = _GUICtrlListView_GetItemText($listview_Temp, $ListView_Selected_Row_Index, 2)
		Local $Response = "You've copied " & $TempName & " to:"
		$List1 = False
		$List2 = False
		$List3 = False
		$List4 = False
		...
		For $x = 1 To 6
			Local $list = "$List" & $x
			Local $AppF = $ApplicationList_Folder & "ApplicationList_Custom_" & $x & ".ini"
			Local $NbrApps1 = IniRead($AppF, "ApplicationList", "NR_Applications", "")
			For $a = 1 To $NbrApps1
				Local $GameTest = IniRead($AppF, "Application_" & $a, "appid", "")
				If $GameTest = $TempAppID Then
					If $x = 1 Then $List1 = True
					If $x = 2 Then $List2 = True
					If $x = 3 Then $List3 = True
					If $x = 4 Then $List4 = True
					If $x = 5 Then $List5 = True
					If $x = 6 Then $List6 = True
					ExitLoop
				EndIf
			Next
		Next
		If $List1 = True Then $Response = $Response & @CRLF & "         Tab4:   " & $TAB4_Label
		If $List2 = True Then $Response = $Response & @CRLF & "         Tab5:   " & $TAB5_Label
		If $List3 = True Then $Response = $Response & @CRLF & "         Tab6:   " & $TAB6_Label
		If $List4 = True Then $Response = $Response & @CRLF & "         Tab7:   " & $TAB7_Label
		If $List5 = True Then $Response = $Response & @CRLF & "         Tab8:   " & $TAB8_Label
		If $List6 = True Then $Response = $Response & @CRLF & "         Tab9:   " & $TAB9_Label
		If $List1 <> True And $List2 <> True And $List3 <> True And $List4 <> True And $List5 <> True And $List6 <> True Then
			$Response = "Your game is not in any CustomTab"
		EndIf
		MsgBox(0, "SSLResponse", $Response)
...
Local $TabState = IniRead($config_ini, "Settings", "ButtonTAB_State", "")
	...
	Local $Array_List[0][8]; = [['appid', 'name', 'FileType', 'InstallDrive', 'SizeOnDisk', 'IconPath', 'GamePath', 'WebURL']]
	...
	For $a = 1 To $ini_Total
		...
		$aGamePath = IniRead($Applist, "Application_" & $a, "GamePath", "")
		$aWebURL = IniRead($Applist, "Application_" & $a, "WebURL", "")
		$aLineString = $aAppId & "|" & $aName & "|" & $aFileType & "|" & $aInstallDrive & "|" & $aSoD & "|" & $aIconPath & "|" & $aGamePath & "|" & $aWebURL
...
;
				...
				$SoD = $Array_List[$b][4]
				$IconPath = $Array_List[$b][5]
				$GamePath = $Array_List[$b][6]
				$WebURL = $Array_List[$b][7]
			...
			If $FileType = "Separator" Then
				...
				Else
					$Sep_App_Pre = "---"
				EndIf
				IniWrite($AppList, "Application_" & $b+1, "appid", $Sep_App_Pre & $b+1 & $Sep_App_Suf)
			Else
...
;			IniWrite($AppList, "Application_" & $b+1, "installdir", "")
			IniWrite($AppList, "Application_" & $b+1, "IconPath", $IconPath)
			IniWrite($AppList, "Application_" & $b+1, "GamePath", $GamePath)
			IniWrite($AppList, "Application_" & $b+1, "WebURL", $WebURL)
...
Func _Radio_2() ; VR Toolbox
	...
	If FileExists($VRTbx_DIR & "\bin\VRToolbox.exe") Then
		...
		_Change_SteamVR_Home_default()
	Else
		MsgBox(0, "Not Installed", "It doesn't appear that VRToolbox is installed.  Please install it before switching.")
	EndIf
EndFunc
...
_Button_Create_GamePage_all()
	...
	Else
		MsgBox(48, "Whoops!", "Something seems to be wrong with the VRToolbox installation structure!")
	EndIf
...
If Not WinExists("StmHmSettings") Then

	$Settings_GUI = GUICreate("StmHmSettings", 506, $HEIGHT_GUI, - 1, - 1, BitOR($WS_MINIMIZEBOX, $WS_CAPTION, $WS_POPUP, $WS_EX_CLIENTEDGE, $WS_EX_TOOLWINDOW))
#Region Folders
...
If Not WinExists("Tab Label") Then
	...
	Global $Label_Form_GUI = GUICreate("Tab Label", 656, 400)
...
Local $Local_SizeOnTest = ""
	...
	If $File <> "" Then
		...
		$Install_Drive = StringUpper($Install_Drive)
			...
			If $appid <> "" Then
				IniWrite($ApplicationList_INI, "Application_" & $Application_NR, "IconPath", $Icons & "steam.app." & $appid & ".jpg")
			Else
...
Func _Button_StartPage()
		...
		$StartPage_path = $StartPage_path1 & "Startpage.html"
			If _FileCountLines($StartPage_path) = 90 Then
...
Func _Create_ListView_1()
	$listview = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview, 2, 525)
	; Add columns
...
#ce
	...
	$RM_ItemList = GUICtrlCreateMenuItem("Has been copied to Tab...", $contextmenu)
...
;	$RM_Item11 = GUICtrlCreateMenuItem("", $contextmenu)
	$RM_Item12 = GUICtrlCreateMenuItem("Edit Mode", $contextmenu)
	$RM_Item13 = GUICtrlCreateMenuItem("Save Edits", $contextmenu)
	$RM_Item14 = GUICtrlCreateMenuItem("Cancel Edits", $contextmenu)
	$RM_Item15 = GUICtrlCreateMenuItem("", $contextmenu)
	$RM_Item16 = GUICtrlCreateMenuItem("", $contextmenu)
	$RM_Item17 = GUICtrlCreateMenuItem("Add Separator", $contextmenu)
	$RM_Item18 = GUICtrlCreateMenuItem("", $contextmenu)
	$RM_Item19 = GUICtrlCreateMenuItem("Delete", $contextmenu)
	GUICtrlSetOnEvent($RM_ItemList, "_Find_Game")
	GUICtrlSetOnEvent($RM_Item1, "_Create_HTMLView_GUI")
	GUICtrlSetOnEvent($RM_Item3, "_Current_Players")
	...
	GUICtrlSetOnEvent($RM_Item13, "_DragDrop_Save")
	GUICtrlSetOnEvent($RM_Item14, "_Cancel_Edit")
	GUICtrlSetOnEvent($RM_Item17, "_RM_Menu_Item_17")
	GUICtrlSetOnEvent($RM_Item19, "_RM_Menu_Item_19")
	GUICtrlSetState($listview, $GUI_HIDE)
EndFunc

Func _Create_ListView_2()    ;   line1496=
	$listview_2 = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview_2, 2, 525)
...
Func _Create_ListView_3()
	$listview_3 = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview_3, 2, 525)
...
Func _Create_ListView_4()
	$listview_4 = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview_4, 2, 525)
...
Func _Create_ListView_5()
	$listview_5 = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview_5, 2, 525)
...
Func _Create_ListView_6()
	$listview_6 = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview_6, 2, 525)
...
Func _Create_ListView_7()
	$listview_7 = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview_7, 2, 525)
...
Func _Create_ListView_8()
	$listview_8 = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview_8, 2, 525)
...
Func _Create_ListView_9()
	$listview_9 = GUICtrlCreateListView("Select|          AppID       | Name |Drive|SizeOnDisk", 0, 115, 845, 740, BitOR($LVS_SHOWSELALWAYS, $LVS_NOSORTHEADER, $LVS_REPORT))
	...
	_GUICtrlListView_SetColumnWidth($listview_9, 2, 525)
...
Determines:
	$Combo_State
	$Status_Combo_Add_to_Custom
	$ButtonTAB_State
		$ApplicationList_TEMP
		$listview_Temp
		$ListView_ImageList_Temp
		$aReturn_Temp
#ce
...
Func _Read_from_INI_ADD_2_ListView()
	...
	_GUIImageList_Destroy($ListView_ImageList_Temp)
	_GUICtrlListView_DeleteAllItems($listview_Temp)
	_GUIListViewEx_Close($ListView_Temp)
	$aReturn_Temp = 0
	$ListView_ImageList_Temp = _GUIImageList_Create(30, 30)
...
;	For $NR = 0 To $NR_Applications
		...
		If $Application_appid <> "" Then
			...
			GUICtrlCreateListViewItem("     |" & $Application_appid & "|" & $Application_name & "|" & $Application_Drive & "|" & $Application_SizeOnDisk, $listview_Temp)
			_GUICtrlListView_SetItemImage($ListView_Temp, $ListView_RowNR, $ListView_RowNR)

			If $FileType = "Separator" Then
				GUICtrlSetColor(-1, $Sep_Color)
			EndIf
...
;	$aReturn_Temp = _GUICtrlListView_CreateArray($listview_Temp, Default) ; Use | as the default delimeter.
;	_GUIListViewEx_Init($listview_Temp, $aReturn_Temp, 0, 0, True, 64) ; No external drag, will accept drop
...
Func _DragDrop_Save()
	...
	If FileExists($iniTemp) Then FileDelete($iniTemp)
	$aReturn = 0
	_Get_State()
	$aReturn = _GUICtrlListView_CreateArray($listview_Temp, Default)
	$temp = $aReturn[0][0]
;	$Sep_AppID_Num = IniRead($ApplicationList_TEMP, "ApplicationList", "NR_Separators", "")
	IniWrite($iniTemp, "ApplicationList", "NR_Applications", $temp)
;	IniWrite($iniTemp, "ApplicationList", "NR_Separators", $Sep_AppID_Num)
	For $yy = 1 to $temp
	$AppId_Temp = $aReturn[$yy][1]
		 For $xx = 1 to $temp
			 $AppId = IniRead($ApplicationList_TEMP, "Application_" & $xx, "appid", "")
			 If $AppId_Temp = $AppId Then
				$Name = IniRead($ApplicationList_TEMP, "Application_" & $xx, "name", "")
				$InstallDrive = IniRead($ApplicationList_TEMP, "Application_" & $xx, "InstallDrive", "")
				$SoD = IniRead($ApplicationList_TEMP, "Application_" & $xx, "SizeOnDisk", "")
				$InstallDir = IniRead($ApplicationList_TEMP, "Application_" & $xx, "installdir", "")
				$IconPath = IniRead($ApplicationList_TEMP, "Application_" & $xx, "IconPath", "")
				$GamePath = IniRead($ApplicationList_TEMP, "Application_" & $xx, "GamePath", "")
				$FileType = IniRead($ApplicationList_TEMP, "Application_" & $xx, "FileType", "")
				$WebURL = IniRead($ApplicationList_TEMP, "Application_" & $xx, "WebURL", "")
				IniWrite($iniTemp, "Application_" & $yy, "NR", $yy)
				If $FileType = "Separator" Then
					If $yy < 10 Then
						$Sep_App_Pre = "---0"
					Else
						$Sep_App_Pre = "---"
					EndIf
					IniWrite($iniTemp, "Application_" & $yy, "appid", $Sep_App_Pre & $yy & $Sep_App_Suf)
				Else
					IniWrite($iniTemp, "Application_" & $yy, "appid", $AppId)
				EndIf
				IniWrite($iniTemp, "Application_" & $yy, "name", $Name)
				IniWrite($iniTemp, "Application_" & $yy, "InstallDrive", $InstallDrive)
				IniWrite($iniTemp, "Application_" & $yy, "SizeOnDisk", $SoD)
				IniWrite($iniTemp, "Application_" & $yy, "installdir", $InstallDir)
				IniWrite($iniTemp, "Application_" & $yy, "IconPath", $IconPath)
				IniWrite($iniTemp, "Application_" & $yy, "GamePath", $GamePath)
				IniWrite($iniTemp, "Application_" & $yy, "FileType", $FileType)
				IniWrite($iniTemp, "Application_" & $yy, "WebURL", $WebURL)
			EndIf
		 Next
	Next
	...
	_GUICtrlListView_DeleteAllItems($listview_Temp)
	_GUIListViewEx_Close($listview_Temp)
	_GUICtrlListView_Destroy($ListView_Temp)
	FileMove($iniTemp, $ApplicationList_TEMP, 1)
	GUIDelete($GUI_Loading)
	If $ButtonTAB_State = 1 Then
		$listview_Temp = $ListView
		_Create_ListView_1()
	...
	GUICtrlSetState($listview_TEMP, $GUI_SHOW)
	GUICtrlSetState($Label_EditMode, $GUI_HIDE)
	GUICtrlSetState($Button_CancelEdit, $GUI_HIDE)
	GUICtrlSetState($ButtonTAB_Steam_Library, $GUI_ENABLE)
	GUICtrlSetState($ButtonTAB_Non_Steam_Appl, $GUI_ENABLE)
	...
	GUICtrlSetState($ButtonTAB_Custom_5, $GUI_ENABLE)
	GUICtrlSetState($ButtonTAB_Custom_6, $GUI_ENABLE)
	GUICtrlSetState($Button_SortAppId, $GUI_ENABLE)
	GUICtrlSetState($Button_SortName, $GUI_ENABLE)
	GUICtrlSetState($Button_Drive, $GUI_ENABLE)
	GUICtrlSetState($Display_WinHome, $GUI_ENABLE)

	GUICtrlSetState($Create_Plaques, $GUI_ENABLE)

	GUICtrlSetState($Button_Settings, $GUI_ENABLE)
	GUICtrlSetState($Button_AddGame2Library, $GUI_ENABLE)
	GUICtrlSetState($Button_ReScan_Revive_Library, $GUI_ENABLE)
	GUICtrlSetState($Button_ReScan_Steam_Library, $GUI_ENABLE)
	GUICtrlSetState($Combo_Add_to_Custom, $GUI_ENABLE)
	GUICtrlSetState($Button_Add_to_Custom, $GUI_ENABLE)
	GUICtrlSetState($Button_Create_GamePage, $GUI_ENABLE)
	GUICtrlSetState($Button_Open_Page, $GUI_ENABLE)
	GUICtrlSetState($Button_Print_GamePage, $GUI_ENABLE)
	GUICtrlSetState($Button_Master_Page, $GUI_ENABLE)
	GUICtrlSetState($Button_Start_Page, $GUI_ENABLE)
	$Edit_State = False
	If $ButtonTAB_State = 1 Then
...
Func _Edit_List()
	Local $aReturnEdit = _GUICtrlListView_CreateArray($ListView_Temp, Default) ; Use | as the default delimeter.
	_GUIListViewEx_Init($ListView_Temp, $aReturnEdit, 0, 0, True, 64) ; External drag & drop - items deleted on drag
	$Edit_State = True
;	GUICtrlSetState($RM_Item11, $GUI_DISABLE)
	GUICtrlSetState($Label_EditMode, $GUI_SHOW)
	GUICtrlSetState($Button_CancelEdit, $GUI_SHOW)
	GUICtrlSetState($ButtonTAB_Steam_Library, $GUI_DISABLE)
	GUICtrlSetState($ButtonTAB_Non_Steam_Appl, $GUI_DISABLE)
	GUICtrlSetState($ButtonTAB_Revive_Apps, $GUI_DISABLE)
	GUICtrlSetState($ButtonTAB_Custom_1, $GUI_DISABLE)
	...
	GUICtrlSetState($Button_SortAppId, $GUI_DISABLE)
	GUICtrlSetState($Button_SortName, $GUI_DISABLE)
	GUICtrlSetState($Button_Drive, $GUI_DISABLE)
	GUICtrlSetState($Display_WinHome, $GUI_DISABLE)
	GUICtrlSetState($Create_Plaques, $GUI_DISABLE)
	GUICtrlSetState($Button_Settings, $GUI_DISABLE)
	GUICtrlSetState($Button_AddGame2Library, $GUI_DISABLE)
	GUICtrlSetState($Button_ReScan_Revive_Library, $GUI_DISABLE)
	GUICtrlSetState($Button_ReScan_Steam_Library, $GUI_DISABLE)
	GUICtrlSetState($Combo_Add_to_Custom, $GUI_DISABLE)
	GUICtrlSetState($Combo_Title, $GUI_DISABLE)
	GUICtrlSetState($Combo_SteamLibrary, $GUI_DISABLE)
	GUICtrlSetState($Button_Add_to_Custom, $GUI_DISABLE)
	GUICtrlSetState($Button_Create_GamePage, $GUI_DISABLE)
	GUICtrlSetState($Button_Open_Page, $GUI_DISABLE)
	GUICtrlSetState($Button_Print_GamePage, $GUI_DISABLE)
	GUICtrlSetState($Button_Master_Page, $GUI_DISABLE)
	GUICtrlSetState($Button_Start_Page, $GUI_DISABLE)
...
Func _RM_Menu_Item_8()   ; RM up ?
	...
	;	$GetItem_installdir_2 = IniRead($ApplicationList_TEMP, "Application_" & $GameNR - 1, "installdir", "")
		...
		If $GetItem_FileType_1 = "Separator" Then
			If $GetItem_NR_2 < 10 Then
				$Sep_App_Pre = "---0"
			Else
				$Sep_App_Pre = "---"
			EndIf
			IniWrite($ApplicationList_TEMP, "Application_" & $GetItem_NR_2, "appid", $Sep_App_Pre & $GetItem_NR_2 & $Sep_App_Suf)
		Else
	...
	;	IniWrite($ApplicationList_TEMP, "Application_" & $GetItem_NR_2, "installdir", $GetItem_installdir_1)
		...
		If $GetItem_FileType_2 = "Separator" Then
				If $GetItem_NR_1 < 10 Then
					$Sep_App_Pre = "---0"
				Else
					$Sep_App_Pre = "---"
				EndIf
				IniWrite($ApplicationList_TEMP, "Application_" & $GetItem_NR_1, "appid", $Sep_App_Pre & $GetItem_NR_1 & $Sep_App_Suf)
			Else
...
;Local $TempText = _GUICtrlListView_GetItemText($listview_Temp, $ListView_Selected_Row_Index, 1)
;MsgBox(0, "", "Row: " & $ListView_Selected_Row_Index + 1)
;MsgBox(0, "", "TempText: " & $TempText)
...
Func _RM_Menu_Item_17()  ; Add Separator
	If $Edit_State = False Then
...
If $Sep_Name <> "" Then
	...
	If $Checker = "Yes" Then
		...
		Local $ListView_Selected_Row_Nr = $ListView_Selected_Row_Index + 1
		$GameNR = $ListView_Selected_Row_Nr
	If $GameNR = "" Then $GameNR = $NbrApps
		If $GameNR < 9 Then
			$Sep_App_Pre = "---0"
		Else
			$Sep_App_Pre = "---"
		EndIf
		Local $Sep_AppId = $Sep_App_Pre & $GameNR & $Sep_App_Suf

		$LastAppNR = IniRead($ApplicationList_TEMP, "ApplicationList", "NR_Applications", "")
		$NewAppNR = $LastAppNR + 1
		Local $AppCount = $NewAppNR - $GameNR

		IniWrite($ApplicationList_TEMP, "ApplicationList", "NR_Applications", $NewAppNR)
	For $x = 1 to $AppCount

		$GetItem_NR_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "NR", "")
		$GetItem_appid_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "appid", "")
		$GetItem_name_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "name", "")
		$GetItem_Drive_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "InstallDrive", "")
		$GetItem_SizeOnDisk_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "SizeOnDisk", "")
;		$GetItem_installdir_1 = IniRead($ApplicationList_TEMP, "Application_" & LastAppNR, "installdir", "")
		$GetItem_IconPath_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "IconPath", "")
		$GetItem_GamePath_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "GamePath", "")
		$GetItem_FileType_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "FileType", "")
		$GetItem_WebURL_1 = IniRead($ApplicationList_TEMP, "Application_" & $LastAppNR, "WebURL", "")

		If $GetItem_FileType_1 = "Separator" Then
			$GetItem_appid_1 = $LastAppNR + 1
			If $GetItem_appid_1 < 9 Then
				$Sep_App_Pre = "---0"
			Else
				$Sep_App_Pre = "---"
			EndIf
			$GetItem_appid_1 = $Sep_App_Pre & $GetItem_appid_1 & $Sep_App_Suf
		EndIf

		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "NR", $LastAppNR + 1)
		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "appid", $GetItem_appid_1)
		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "name", $GetItem_name_1)
		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "InstallDrive", $GetItem_Drive_1)
		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "SizeOnDisk", $GetItem_SizeOnDisk_1)
;		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "installdir", $GetItem_installdir_1)
		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "IconPath", $GetItem_IconPath_1)
		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "GamePath", $GetItem_GamePath_1)
		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "FileType", $GetItem_FileType_1)
		IniWrite($ApplicationList_TEMP, "Application_" & $LastAppNR + 1, "WebURL", $GetItem_WebURL_1)

		$LastAppNR = $LastAppNR - 1
	Next

		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "NR", $GameNR)
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "appid", $Sep_AppId)
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "name", $Sep_Name)
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "InstallDrive", $Sep_Drive)
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "SizeOnDisk", $Sep_SoD)
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "installdir", "")
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "IconPath", $Sep_Pic)
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "GamePath", "")
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "FileType", "Separator")
		IniWrite($ApplicationList_TEMP, "Application_" & $GameNR, "WebURL", "")
...
Func _RM_Menu_Item_19() ; Delete ListView item    line2139
	If $Edit_State = False Then
		$Combo = GUICtrlRead($Combo_SteamLibrary)
		$Combo_State = StringReplace($Combo, 'Steam Library ', '')
	...
	;			$GetItem_installdir_next = IniRead($ApplicationList_TEMP, "Application_" & $Loop_Temp, "installdir", "")
				...
				If $GetItem_FileType_next = "Separator" Then
					If $Loop_Temp - 1 < 10 Then
						$Sep_App_Pre = "---0"
					Else
						$Sep_App_Pre = "---"
					EndIf
					IniWrite($ApplicationList_TEMP, "Application_" & $Loop_Temp - 1, "appid", $Sep_App_Pre & $Loop_Temp - 1 & $Sep_App_Suf)
				Else
...
Func _Button_Create_GamePage_selected()
	...
	Else
		...
		If $ButtonTAB_State = "7" Then $WebPage_Title = $Label_Web_Title7
		...
		For $NR = 1 To $NR_Applications
			...
			If _GUICtrlListView_GetItemChecked($listview_Temp, $NR - 1) Then
				...
				If $WinName = "VR Toolbox" Then
						...
						ElseIf $Application_FileType = "Separator" Then
							FileWriteLine($GamePage_path, '<div class="separator"><p>' & $Application_name & ' <---' & '</p></div>')
...
;					Global $Application_installdir = IniRead($ApplicationList_TEMP, "Application_" & $NR, "installdir", "")
					...
					IniWrite($ApplicationList_target, "ApplicationList", "NR_Applications", $NewAppNR)                     ;Number of Apps
...
Func _Object_Picker()
	...
	If $TEMP_NR_selected = "true" Then
		...
		$OPForm1 = GUICreate("OPForm1", 518, 445)
		$ObjectLabel = GUICtrlCreateLabel("Pick your Object:", 175, 8, 177, 32, BitOR($SS_CENTER,$SS_SUNKEN))
		GUICtrlSetFont(-1, 14, 800, 4, "MS Sans Serif")

		$OPRadio1 = GUICtrlCreateRadio("  Plaque", 20, 64, 120, 20)
		GUICtrlSetState($OPRadio1, $GUI_UNCHECKED)
		$OPRadio2 = GUICtrlCreateRadio("  Eagle1", 20, 112, 120, 20)
		GUICtrlSetState($OPRadio2, $GUI_UNCHECKED)
		$OPRadio3 = GUICtrlCreateRadio("  Eagle2", 20, 160, 120, 20)
		GUICtrlSetState($OPRadio3, $GUI_UNCHECKED)
		$OPRadio4 = GUICtrlCreateRadio("  Monitor1", 20, 208, 120, 20)
		GUICtrlSetState($OPRadio4, $GUI_UNCHECKED)
		$OPRadio5 = GUICtrlCreateRadio("  BareBones", 20, 256, 120, 20)
		GUICtrlSetState($OPRadio5, $GUI_UNCHECKED)


		$OPRadio6 = GUICtrlCreateRadio("  ArcadeA", 270, 64, 120, 20)
		GUICtrlSetState($OPRadio6, $GUI_UNCHECKED)
		$OPRadio7 = GUICtrlCreateRadio("  ArcadeB", 270, 112, 120, 20)
		GUICtrlSetState($OPRadio7, $GUI_UNCHECKED)
		$OPRadio8 = GUICtrlCreateRadio("  ArcadeC", 270, 160, 120, 20)
		GUICtrlSetState($OPRadio8, $GUI_UNCHECKED)
		$OPRadio9 = GUICtrlCreateRadio("  ArcadeD", 270, 208, 120, 20)
		GUICtrlSetState($OPRadio9, $GUI_UNCHECKED)

		$OPCancelButton = GUICtrlCreateButton("Cancel", 48, 384, 89, 41)
		GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
		GUICtrlSetOnEvent($OPCancelButton, "_Button_Exit_ObjectPicker_GUI")
		$OPOkButton = GUICtrlCreateButton("Ok", 184, 384, 89, 41)
		GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
		GUICtrlSetOnEvent($OPOkButton, "_Create_Object")
		GUISetState(@SW_SHOW)
	Else
		MsgBox($MB_ICONWARNING, "No Application selected", "You need to select at least one Application to be able to create the Object Shortcut.")
	EndIf
...
Func _Create_Object()
	$Object_Type = ""
	If GUICtrlRead($OPRadio1) = $GUI_CHECKED Then
		$Object_Type = "Plaque"
		GUICtrlSetState($OPRadio1, $GUI_UNCHECKED)
		_Write_2_Room()
	ElseIf GUICtrlRead($OPRadio2) = $GUI_CHECKED Then
		$Object_Type = "Eagle1"
		GUICtrlSetState($OPRadio2, $GUI_UNCHECKED)
		$EagleSize = 0.550160229206085
		_Write_2_Room()
	ElseIf GUICtrlRead($OPRadio3) = $GUI_CHECKED Then
		$Object_Type = "Eagle2"
		GUICtrlSetState($OPRadio3, $GUI_UNCHECKED)
		$EagleSize = 0.350160229206085
		_Write_2_Room()
	ElseIf GUICtrlRead($OPRadio4) = $GUI_CHECKED Then
		$Object_Type = "Monitor1"
		GUICtrlSetState($OPRadio4, $GUI_UNCHECKED)
		_Write_2_Room()
	ElseIf GUICtrlRead($OPRadio5) = $GUI_CHECKED Then
		$Object_Type = "BareBones"
		GUICtrlSetState($OPRadio5, $GUI_UNCHECKED)
		_Write_2_Room()
	ElseIf GUICtrlRead($OPRadio6) = $GUI_CHECKED Then
		$Object_Type = "ArcadeA"
		GUICtrlSetState($OPRadio6, $GUI_UNCHECKED)
		_Write_2_Room()
	ElseIf GUICtrlRead($OPRadio7) = $GUI_CHECKED Then
		$Object_Type = "ArcadeB"
		GUICtrlSetState($OPRadio7, $GUI_UNCHECKED)
		_Write_2_Room()
	ElseIf GUICtrlRead($OPRadio8) = $GUI_CHECKED Then
		$Object_Type = "ArcadeC"
		GUICtrlSetState($OPRadio8, $GUI_UNCHECKED)
		_Write_2_Room()
	ElseIf GUICtrlRead($OPRadio9) = $GUI_CHECKED Then
		$Object_Type = "ArcadeD"
		GUICtrlSetState($OPRadio9, $GUI_UNCHECKED)
		_Write_2_Room()
	EndIf
...
Func _Button_Exit_ObjectPicker_GUI()
...
Func _Write_2_Room()
	...
	$Ymonitor1 = .75
	$Zmonitor1 = -1
	Local $Plaque_Count = 1
	Local $ArcadeA_Count = 1
	Local $Eagle1_Count = 1
	Local $Monitor1_Count = 1
	$listview_Temp = $ListView

	If Not FileExists($Object_Room) Then
		_Write_base_room()
	EndIf
...
;GUICtrlSetData($Display_Progressbar, 20)
	For $NR = 1 To $NR_Applications
		...
		If _GUICtrlListView_GetItemChecked($listview_Temp, $NR - 1) Then
			Global $Application_NR = IniRead($ApplicationList_TEMP, "Application_" & $NR, "NR", "")
			Global $AppId = IniRead($ApplicationList_TEMP, "Application_" & $NR, "appid", "")
			If $Object_Type = "Plaque" Or $Object_Type = "BareBones" Then
				If $Object_Type = "Plaque" Then
					_Write_Cut_2_Room()
				Else
					_Write_Plane_2_Room()
				EndIf
				$Xplaque = $Xplaque + .445
				If $Plaque_Count = 6 Then
					$Yplaque = $Yplaque + .21
					$Xplaque = -1.18
					$Plaque_Count = 0
				EndIf
				$Plaque_Count = $Plaque_Count + 1
			ElseIf $Object_Type = "Eagle1" Or $Object_Type = "Eagle2" Then
				_Write_Eagle_2_Room()
				$Xeagle1 = $Xeagle1 + .42
				If $Eagle1_Count = 6 Then
					$Yeagle1 = $Yeagle1 + .3
					$Xeagle1 = -1.1
					$Eagle1_Count = 0
				EndIf
				$Eagle1_Count = $Eagle1_Count + 1
			ElseIf $Object_Type = "Monitor1" Then
				_Write_Monitor_2_Room()
				$Xmonitor1 = $Xmonitor1 + .55
				If $Monitor1_Count = 6 Then
					$Ymonitor1 = $Ymonitor1 + .4
					$Xmonitor1 = -1.1
					$Monitor1_Count = 0
				EndIf
				$Monitor1_Count = $Monitor1_Count + 1
			ElseIf $Object_Type = "ArcadeA" Or $Object_Type = "ArcadeD" Then
				If $Object_Type = "ArcadeA" Then
					$Cabinet = "A"
					$ObjectPath = "props/arcade_cabinetA/Arcade_cabinetA.obj"
				Else
					$Cabinet = "D"
					$ObjectPath = "props/arcade_cabinetD/Arcade_cabinetD.obj"
				EndIf
				_Write_ArcadeAD_2_Room()
				$XarcA = $XarcA + 1
				If $ArcadeA_Count = 5 Then
					$ZarcA = $ZarcA + 1
					$XarcA = -2
					$ArcadeA_Count = 0
				EndIf
				$ArcadeA_Count = $ArcadeA_Count + 1
			ElseIf $Object_Type = "ArcadeB" Then
					$Cabinet = "B"
					$ObjectPath = "props/arcade_cabinetB/Arcade_cabinetB.obj"
				_Write_ArcadeB_2_Room()
				$XarcA = $XarcA + 1
				If $ArcadeA_Count = 5 Then
					$ZarcA = $ZarcA + 1
					$XarcA = -2
				...
				EndIf
				$ArcadeA_Count = $ArcadeA_Count + 1
			ElseIf $Object_Type = "ArcadeC" Then
					$Cabinet = "C"
					$ObjectPath = "props/arcade_cabinetC/Arcade_cabinetC.obj"
				_Write_ArcadeC_2_Room()
				$XarcA = $XarcA + 1
				If $ArcadeA_Count = 5 Then
					$ZarcA = $ZarcA + 1
					$XarcA = -2
	...
	GUICtrlSetData($Display_Progressbar, 100)
	If $Object_Type = "Plaque" Then
		MsgBox(0, "Operation Completed", "Game Plaques created", 1)
	ElseIf $Object_Type = "Eagle1" Or $Object_Type = "Eagle2" Then
		MsgBox(0, "Operation Completed", "Eagle Object created", 1)
	ElseIf $Object_Type = "Monitor1" Then
		MsgBox(0, "Operation Completed", "Monitor Object created", 1)
	ElseIf $Object_Type = "BareBones" Then
		MsgBox(0, "Operation Completed", "Steam Shortcut Object created", 1)
	ElseIf $Object_Type = "ArcadeA" Then
		MsgBox(0, "Operation Completed", "ArcadeA Machine Objects created", 1)
	ElseIf $Object_Type = "ArcadeB" Then
		MsgBox(0, "Operation Completed", "ArcadeB Machine Objects created", 1)
	ElseIf $Object_Type = "ArcadeC" Then
		MsgBox(0, "Operation Completed", "ArcadeC Machine Objects created", 1)
	ElseIf $Object_Type = "ArcadeD" Then
		MsgBox(0, "Operation Completed", "ArcadeD Machine Objects created", 1)
	EndIf
	Sleep(600)
	GUICtrlSetData($Display_Progressbar, 0)
	_Button_Exit_ObjectPicker_GUI()
	_GUICtrlListView_SetItemChecked($listview_Temp, -1, False)
EndFunc

Func _Clear_Room()
	FileDelete($Object_Room)
	_Write_base_room()
EndFunc

Func _Write_base_room()
	FileWriteLine($Object_Room, '{' & @CRLF & _
								' "TopContainer": {'	 & @CRLF & _
								' "Screen0": {' & @CRLF & _
								'  "Capture": {' & @CRLF & _
...
Func _Write_ArcadeC_2_Room()

	Local $lineCount = _FileCountLines($Object_Room) - 2
	_FileWriteToLine($Object_Room, $lineCount - 1, "  },", True)
	_FileWriteToLine($Object_Room, $lineCount, ' "arcade_cabinet' & $Cabinet & '_' & $AppId & '001bea728d0457b0": {' & @CRLF & _
					'  "AltSkin": false,' & @CRLF & _
					'  "Children": {' & @CRLF & _
					'	 "SteamShortcut_' & $AppId & '_001be9f2e45bf748": {' & @CRLF & _
					'	  "AppId": ' & $AppId & ',' & @CRLF & _
					'	  "Children": null,' & @CRLF & _
					'	  "ClassID": "SteamShortcut",' & @CRLF & _
					'	  "Settings": {' & @CRLF & _
					'	   "CylRadius": 100,' & @CRLF & _
					'	   "Flags": 33041,' & @CRLF & _
					'	   "Stereo": 0,' & @CRLF & _
					'	   "Transparency": 0' & @CRLF & _
					'	  },' & @CRLF & _
					'	  "WorldMatrix": [' & @CRLF & _
					'	   1.0159717798233,' & @CRLF & _
					'	   -3.49719789483061e-06,' & @CRLF & _
					'	   -0.0137051371857524,' & @CRLF & _
					'	   0.006388233974576,' & @CRLF & _
					'	   3.49794163412298e-06,' & @CRLF & _
					'	   2.04,' & @CRLF & _
					'	   3.87020016034967e-08,' & @CRLF & _
					'	   0.424053151130676,' & @CRLF & _
					'	   0.0137051371857524,' & @CRLF & _
					'	   -8.58826751937158e-08,' & @CRLF & _
					'	   1.0159717798233,' & @CRLF & _
					'	   0.121854193611145,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   1' & @CRLF & _
...
Func _Write_ArcadeB_2_Room()
	...
	_FileWriteToLine($Object_Room, $lineCount, ' "arcade_cabinet' & $Cabinet & '_' & $AppId & '001bea728d0457b0": {' & @CRLF & _
					...
					'	  },' & @CRLF & _
					'	  "WorldMatrix": [' & @CRLF & _
					'	   0.954390287399292,' & @CRLF & _
					'	   0.00197263993322849,' & @CRLF & _
					'	   -0.00541122257709503,' & @CRLF & _
					'	   0.0014466792345047,' & @CRLF & _
					'	   -0.0006765176076442,' & @CRLF & _
					'	   2.07,' & @CRLF & _
					'	   0.486535826,' & @CRLF & _
					'	   0.304146151542664,' & @CRLF & _
					'	   0.00571970641613007,' & @CRLF & _
					'	   -0.486535826,' & @CRLF & _
					'	   0.928855955600739,' & @CRLF & _
					'	   0.075,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
...
Func _Write_Monitor_2_Room()
	Local $lineCount = _FileCountLines($Object_Room) - 2
	_FileWriteToLine($Object_Room, $lineCount - 1, "  },", True)
	_FileWriteToLine($Object_Room, $lineCount, ' "modern_monitor_' & $AppId & '_001acddcf81b94e5": {' & @CRLF & _
					'  "AltSkin": false,' & @CRLF & _
					'  "Children": {' & @CRLF & _
					'	 "SteamShortcut_' & $AppId & '_001acdf8f8279674": {' & @CRLF & _
					'	  "AppId": ' & $AppId & ',' & @CRLF & _
					'	  "Children": null,' & @CRLF & _
					'	  "ClassID": "SteamShortcut",' & @CRLF & _
					'	  "Settings": {' & @CRLF & _
					'	   "CylRadius": 100,' & @CRLF & _
					'	   "Flags": 8421649,' & @CRLF & _
					'	   "Stereo": 0,' & @CRLF & _
					'	   "Transparency": 0' & @CRLF & _
					'	  },' & @CRLF & _
					'	  "WorldMatrix": [' & @CRLF & _
					'	   1.11003267765045,' & @CRLF & _
					'	   -0.000214486019103788,' & @CRLF & _
					'	   -0.00304864719510078,' & @CRLF & _
					'	   0.000417202711105347,' & @CRLF & _
					'	   0.000188588121091016,' & @CRLF & _
					'	   1.28801202774048,' & @CRLF & _
					'	   -1.17430136015173e-06,' & @CRLF & _
					'	   0.0416956310272217,' & @CRLF & _
					'	   0.00053196805715561,' & @CRLF & _
					'	   -1.25875712910783e-05,' & @CRLF & _
					'	   0.993922054767609,' & @CRLF & _
					'	   0.0319,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					...
					'	"ClassID": "PropMesh",' & @CRLF & _
					'	"Flags": 274,' & @CRLF & _
					'	"ObjectPath": "props/modern_monitor/modern_monitor.obj",' & @CRLF & _
					'  "WorldMatrix": [' & @CRLF & _
					'   1,0,0,' & $Xmonitor1 & ',' & @CRLF & _
					'   0,1,0,' & $Ymonitor1 & ',' & @CRLF & _
					'   0,0,1,' & $Zmonitor1 & ',' & @CRLF & _
					'   0,0,0,1' & @CRLF & _
					'  ]' & @CRLF & _
					' }', False)
...
Func _Write_Eagle_2_Room()
	Local $lineCount = _FileCountLines($Object_Room) - 2
	_FileWriteToLine($Object_Room, $lineCount - 1, "  },", True)
	_FileWriteToLine($Object_Room, $lineCount, ' "statuette_bird_' & $AppId & '_001a22f079eef59b": {' & @CRLF & _
					'  "AltSkin": false,' & @CRLF & _
					'  "Children": {' & @CRLF & _
					'	 "SteamShortcut_' & $AppId & '_0019b790755739f7": {' & @CRLF & _
					'	  "AppId": ' & $AppId & ',' & @CRLF & _
					'	  "Children": null,' & @CRLF & _
					'	  "ClassID": "SteamShortcut",' & @CRLF & _
					'	  "Settings": {' & @CRLF & _
					...
					'	  "WorldMatrix": [' & @CRLF & _
					'	   ' & $EagleSize & ',' & @CRLF & _
					'	   0.000243392467382364,' & @CRLF & _
					'	   -0.00120830908417702,' & @CRLF & _
					'	   -0.00450348246097565,' & @CRLF & _
					'	   -0.000243391536059789,' & @CRLF & _
					'	   0.550161480903625,' & @CRLF & _
					'	   6.96829033586255e-07,' & @CRLF & _
					'	   0.0500386953353882,' & @CRLF & _
					'	   0.00120830908417702,' & @CRLF & _
					'	   -1.62270225700922e-07,' & @CRLF & _
					'	   0.550160229206085,' & @CRLF & _
					'	   0.0472,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					...
					'	"ClassID": "PropMesh",' & @CRLF & _
					'	"Flags": 33042,' & @CRLF & _
					'	"ObjectPath": "props/statuette_bird/Statuette_birdA.obj",' & @CRLF & _
					'  "WorldMatrix": [' & @CRLF & _
					'   1,0,0,' & $Xeagle1 & ',' & @CRLF & _
					'   0,1,0,' & $Yeagle1 & ',' & @CRLF & _
					'   0,0,1,' & $Zeagle1 & ',' & @CRLF & _
					'   0,0,0,1' & @CRLF & _
					'  ]' & @CRLF & _
					' }', False)
...
Func _Write_ArcadeAD_2_Room()

	Local $lineCount = _FileCountLines($Object_Room) - 2
	_FileWriteToLine($Object_Room, $lineCount - 1, "  },", True)
	_FileWriteToLine($Object_Room, $lineCount, ' "arcade_cabinet' & $Cabinet & '_' & $AppId & '_00135cf1184c4c24": {' & @CRLF & _
					'  "AltSkin": false,' & @CRLF & _
					'  "Children": {' & @CRLF & _
					'	 "SteamShortcut_' & $AppId & '_0019b790755739f7": {' & @CRLF & _
					'	  "AppId": ' & $AppId & ',' & @CRLF & _
					...
					'	  "WorldMatrix": [' & @CRLF & _
					'	   1.105,' & @CRLF & _
					'	   0.0041482225060463,' & @CRLF & _
					'	   -0.0149406492710114,' & @CRLF & _
					'	   0.000242727808654308,' & @CRLF & _
					'	   -0.000979184289462864,' & @CRLF & _
					'	   1.55,' & @CRLF & _
					'	   0.343846,' & @CRLF & _
					'	   0.4710,' & @CRLF & _
					'	   0.0154749155044556,' & @CRLF & _
					'	   -0.343846,' & @CRLF & _
					'	   0.969564974308014,' & @CRLF & _
					'	   0.00940877199172974,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   1' & @CRLF & _
...
Func _Write_Cut_2_Room()
	Local $lineCount = _FileCountLines($Object_Room) - 2
	_FileWriteToLine($Object_Room, $lineCount - 1, "  },", True)
	_FileWriteToLine($Object_Room, $lineCount, ' "SteamShortcut_' & $AppId & '_000e59b7e041e22c": {' & @CRLF & _
					'	"AppId": ' & $AppId & ',' & @CRLF & _
					'	"Children": {' & @CRLF & _
					'	 "SteamShortcut_' & $AppId & '_000e59b7e041e22c_Plaque": {' & @CRLF & _
					'	  "AltSkin": false,' & @CRLF & _
					'	  "ClassID": "PropMesh",' & @CRLF & _
					'	  "Flags": 4368,' & @CRLF & _
					'	  "ObjectPath": "props/marble_plaque/marble_plaque.obj",' & @CRLF & _
					'	  "WorldMatrix": [' & @CRLF & _
					'	   1,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					'	   0.0,' & @CRLF & _
					...
					'  },' & @CRLF & _
					'  "WorldMatrix": [' & @CRLF & _
					'   1,0,0,' & $Xplaque & ',' & @CRLF & _
					'   0,1,0,' & $Yplaque & ',' & @CRLF & _
					'   0,0,1,' & $Zplaque & ',' & @CRLF & _
					'   0,0,0,1' & @CRLF & _
					'  ]' & @CRLF & _
					' }', False)
...
Func _Write_Plane_2_Room()
	Local $lineCount = _FileCountLines($Object_Room) - 2
	_FileWriteToLine($Object_Room, $lineCount - 1, "  },", True)
	_FileWriteToLine($Object_Room, $lineCount, ' "SteamShortcut_' & $AppId & '_00235f87688e4c58": {' & @CRLF & _
					'	"AppId": ' & $AppId & ',' & @CRLF & _
					'	"Children": null,' & @CRLF & _
					'	"ClassID": "SteamShortcut",' & @CRLF & _
					'	"Settings": {' & @CRLF & _
...
;	FileCopy($Value_IconPath_Folder, $Steam_Icons & $Value_Use_SteamID & ".jpg")
	...
	IniWrite($config_ini, "TEMP", "Value_FileType", "")
